...
// Source: github.com/ozoncp/ocp-issue-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Issue) []models.Issue {
	m.ctrl.T.Helper()
